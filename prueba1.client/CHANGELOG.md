...
- Create Angular project with ng: `ng new prueba1.client --defaults --skip-install --skip-git `.
...
- Create project file (`prueba1.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `prueba1.client.esproj`).
